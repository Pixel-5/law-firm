<div class="container-fluid">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control"
                   name="transferor_marital_status"
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control"
                   name="transferor_postal_address"
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                ...
                class="form-control" name="transferor_tel">
                <input type="tel" @if($file != null) value="{{ $file->cell }}" @endif
                class="form-control" name="transferor_cell">
                <input type="tel" @if($file != null) value="{{ $file->fax }}" @endif
                class="form-control" name="transferor_alt">
            </div>
        </div>
    </div>
    <div class="form-row">
