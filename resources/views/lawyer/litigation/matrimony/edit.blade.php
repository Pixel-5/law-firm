                        ...
                        <div class="container">
                            <div class="row-cols-1">
                                <div class="form-group ">
                                    ...
                                    <input type="text" id="omang_name" class="form-control" name="omang_name"
                                           value="{{ $file->matrimony->omang_name }}">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" id="marriage_certificate_name" class="form-control"
                                           name="marriage_certificate_name"  value="{{ $file->matrimony->marriage_name }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="maiden_name"
                                           name="maiden_name"  value="{{ $file->matrimony->maiden_name }}">
                            ...
                            <div class="row-cols-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="file-upload-wrapper">
                                        <input type="file" id="marriage_certificate" name="marriage_certificate_copy"
                                               class="file-upload" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row-cols-1">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="nationality_residence"
                                           value="{{ $file->client->clientable->nationality }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-1">
                                            <label class="radio-inline"> Yes
                                                ...
                                                @if($file->matrimony->is_citizen == 1)checked @endif>
                                            </label>
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label class="radio-inline"> No
                                                <input type="radio" name="is_citizen" value="No"
                                                       @if($file->matrimony->is_citizen == 0)checked @endif>
                                            </label>
                                        </div>
                                    </div>
                                </div>
